...
$page = new admin_settingpage(
    "theme_govbrds_general",
    get_string("generalsettings", "theme_govbrds"),
);
...
$setting = new admin_setting_confightmleditor(
    ...
    get_string("addressm", "theme_govbrds"),
...
$setting = new admin_setting_configcheckbox(
    "theme_govbrds/layout",
    get_string("layout", "theme_govbrds"),
    get_string("layout_desc", "theme_govbrds"),
    "Fluid",
    "Fluid",
    "Fixed",
);
