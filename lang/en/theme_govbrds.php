...
$string['tab'] = 'Tab';
$string['tabdesc'] = 'A custom menu may be configured here. Enter each menu item on a new line with format: menu text, a link URL and a tooltip title, separated by pipe characters. <pre><br/>eLearn|https://example.com/|Online Study Platform <br/> Mooc|https://example.com/mooc|MOOC Platform <br />Workspace|https://example.com/workspace|Corporative Training Environment</pre>';
